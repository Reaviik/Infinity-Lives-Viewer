...
const twitchChannels = {
  ...
  laluts1:          { name: 'LALUTS',          color: 'bg-gradient-to-br from-emerald-500 to-lime-500', type: 'iniciante' },
  lorran_aa:        { name: 'SabugOza',        color: 'bg-gradient-to-br from-gray-400 to-gray-600', type: 'desertor' },
